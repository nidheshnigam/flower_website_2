...
<section class="contact" id="contact">
    ...
    <div class="row">
        ...
        <form action="form.php" method="post">
            <input type="text" placeholder="name" class="box" name="n1">
            <input type="email" placeholder="email" class="box" name="e1">
            <input type="number" placeholder="number" class="box" name="num1">
            <textarea name="" class="box" placeholder="message" id="" cols="30" rows="10" name="m1"></textarea>
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <h3>contact info</h3>
            <a href="#">+919170382319</a>
            <a href="#">pdohu1050@gmail.com</a>
            <a href="#">Lucknow, india - 221717</a>
            <img src="images/payment.png" alt="">
        </div>

    </div>

    <div class="credit"> created by <span> Nidhesh Nigam </span> | all rights reserved </div>
